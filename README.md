...
# 🛒 Retail Sales Data Pipeline on Azure

An end-to-end Azure Data Engineering project built to ingest, transform, store, and visualize retail sales data using modern Azure cloud technologies.
